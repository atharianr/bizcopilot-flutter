...
class BizTextStyles {
  ...
  /// titleLargeBold Text Style
  static TextStyle titleLargeBold = _commonStyle.copyWith(
    fontSize: 22,
    fontWeight: FontWeight.w700,
    height: 1.2,
  );
  ...
  static TextStyle titleSmallBold = _commonStyle.copyWith(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    height: 1.2,
  );
  ...
  /// labelSmallMedium Text Style
  static TextStyle labelSmallMedium = _commonStyle.copyWith(
    fontSize: 10,
    fontWeight: FontWeight.w500,
    height: 1.2,
  );
